...
<aside class="navigation">
    <nav>
        <ul class="nav luna-nav">
            ...
            <li class="active">
                <a href="dashboard">
                    <span class="fa fa-lg fa-home"></span> Dashboard
                </a>
            </li>
            ...
            <li class="nav-info">
                ...
                <div class="m-t-xs">
                    <span class="c-white">TienDat</span> admin theme with Dark UI style for monitoring and administration web applications.
                </div>
            </li>
        </ul>
    </nav>
